...
use Backpack\CRUD\PanelTraits\CreateParams;
...
class CrudPanel
{
    use Create, Read, Search, Update, Delete, Errors, Reorder, Access, Actions, Columns, CreateParams, Fields, Query, Buttons, AutoSet, FakeFields, FakeColumns, ViewsAndRestoresRevisions, AutoFocus, Filters, Tabs, Views, RequiredFields;
