...
class CrudPanel
{
    use Create, Read, Update, Delete, Errors, Reorder, Access, Actions, Columns, Fields, Query, Buttons, AutoSet, FakeFields, FakeColumns, ViewsAndRestoresRevisions, AutoFocus, Filters, Tabs, Views;
