...
<div class="row">
	<div class="col-md-8 col-md-offset-2">
        ...
        @if ($returnUrl != $crud->route)
            <a href="{{ url(urldecode($returnUrl)) }}" class="hidden-print"><i class="fa fa-angle-double-left"></i> {{ trans('backpack::crud.back_to_all') }} <span>{{ $crud->entity_name_plural }}</span></a><br><br>
