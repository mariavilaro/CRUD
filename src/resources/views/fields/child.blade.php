...
?>
<div ng-app="backPackChildApp" ng-controller="childController" @include('crud::inc.field_wrapper_attributes') >
...
@if ($crud->checkIfFieldIsFirstOfItsType($field, $fields))
    ...
    @push('crud_fields_scripts')
        ...
        <script>
            ...
            window.angularApp2 = window.angularApp2 || angular.module('backPackChildApp', ['ui.sortable'], function($interpolateProvider){
                $interpolateProvider.startSymbol('<%');
                $interpolateProvider.endSymbol('%>');
            });


            window.angularApp2.controller('childController', function($scope){
                ...
                $scope.$watch('items', function(a, b){
                    ...
                    } else if ($scope.items != 'undefined' && !$scope.items.length) {
                        if( typeof $scope.field != 'undefined'){
                            if( typeof $scope.field == 'string' ){
                                $scope.field = $($scope.field);
                            }
            ...
            window.angularApp2.directive('postRender', function($timeout) {
                return {
